...
with per-node size aggregation, and filters it by a text query.
"""
import zipfile
...
class FileTreeBuilder:
    def build(self, apk_path: str) -> dict:
    ...
    def _insert_entry(self, root_node: dict, info: zipfile.ZipInfo) -> None:
    ...
    def _aggregate_folder_sizes(self, node_dict: dict):
        """
...
class FileTreeFilter:
    def filter(self, node_dict: dict, query: str) -> dict:
    ...
    def _filter_recursive(self, node_dict: dict, query: str, force_include: bool) -> dict:
        filtered = {}
